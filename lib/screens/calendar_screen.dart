...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedPanchang = PanchangEngine.calculate(
      _selectedDay,
      city.utcOffset,
    );
          ...
          Expanded(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildSelectedDayPanchang(selectedPanchang, s),
    ...
    return Container(
      ...
      child: TableCalendar(
        ...
        headerStyle: HeaderStyle(
          ...
          leftChevronIcon: const Icon(Icons.chevron_left, color: _saffron),
          rightChevronIcon: const Icon(Icons.chevron_right, color: _saffron),
        ),
  ...
  Widget _buildSelectedDayPanchang(PanchangData p, AppStrings s) {
    return Container(
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                '${s.weekday(p.varaName)} — ${s.tithiName(p.tithiName)}',
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _chip(s.paksha(p.tithiPaksha), Colors.orange),
              _chip('☽ ${s.nakshatraName(p.nakshatraName)}', Colors.purple),
              _chip('◎ ${s.yogaName(p.yogaName)}', Colors.teal),
              _chip('◑ ${s.karanaName(p.karanaName)}', Colors.indigo),
            ],
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.celebration, color: _saffron, size: 18),
              const SizedBox(width: 8),
              Text(
                s.festivalsTitle, // was 'Festivals & Events'
                style: const TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.bold,
                  color: _saffron,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          f.nameHindi,
                          style: const TextStyle(fontSize: 13, color: _saffron),
                        ),
                        Text(
                          f.description,
                          style: TextStyle(
